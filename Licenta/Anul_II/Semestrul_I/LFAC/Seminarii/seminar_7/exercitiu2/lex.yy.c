...
static yyconst flex_int16_t yy_base[23] =
    {   0,
        0,    0,   17,   18,    3,   13,    0,   12,    0,    5,
       11,    0,    0,   10,    0,    0,    0,    0,   18,   10,
        9,    8
    } ;

static yyconst flex_int16_t yy_def[23] =
    {   0,
       19,    1,   19,   19,   19,    5,    5,    5,    6,   19,
       10,   10,   20,   10,   21,   10,   22,   20,    0,   19,
       19,   19
    } ;

static yyconst flex_int16_t yy_nxt[23] =
    {   0,
        4,    5,    6,    4,    7,    8,   11,   12,   13,   18,
       17,   15,   16,   14,   10,    9,   19,    3,   19,   19,
       19,   19
    } ;

static yyconst flex_int16_t yy_chk[23] =
    {   0,
        1,    1,    1,    1,    5,    5,   10,   10,   10,   22,
       21,   20,   14,   11,    8,    6,    3,   19,   19,   19,
       19,   19
    } ;
